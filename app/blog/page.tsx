...
export default function BlogPage() {
  ...
  const posts = [
    {
      slug: "implementing-string-pattern-matching-using-dfa",
      title: "implementing string pattern matching using dfa",
      date: "jul 5, 2024",
    },
    {
      slug: "racing-macos",
    ...
    {
      slug: "how-i-organise-my-life",
      title: "how i organise my life",
      date: "aug 3, 2023",
    },
    {
      slug: "why-i-switched-from-nodejs-to-vscode",
      title: "why i switched from nodejs to vscode",
      date: "jun 24, 2023",
    },
    {
      slug: "everything-i-installed-on-my-new-mac",
      title: "everything i installed on my new mac",
      date: "jun 2, 2023",
    },
    {
      slug: "rust-not-just-zoom-zoom-fast",
      title: "rust: not just zoom zoom fast",
      date: "feb 25, 2023",
    },
    {
      slug: "implementing-the-pipe-operator-in-typescript",
      title: "implementing the pipe operator in typescript",
      date: "jan 21, 2023",
    },
    {
      slug: "expressive-code-with-pattern-matching",
      title: "expressive code with pattern matching",
      date: "dec 29, 2022",
    },
    {
      slug: "typeorm-database-queries-on-the-edge",
      title: "typeorm database queries on the edge",
      date: "nov 12, 2022",
    },
    {
      slug: "my-developer-workflow-using-wsl-tmux-and-neovim",
      title: "my developer workflow using wsl, tmux and neovim",
      date: "aug 16, 2022",
    },
    {
      slug: "t3-stack-and-my-most-popular-open-source-project-ever",
      title: "t3 stack and my most popular open source project ever",
      date: "jun 27, 2022",
    },
    {
      slug: "create-licenses-for-your-projects-right-from-the-terminal",
      title: "create licenses for your projects right from the terminal",
      date: "mar 25, 2022",
    },
    {
      slug: "i-made-a-wordle-clone",
  ...
  useEffect(() => {
    const handleKeyPress = (event: KeyboardEvent) => {
      if (event.key === "/" && !showSearch) {
        ...
        // Allow normal typing in search input, but handle Esc above
        return;
